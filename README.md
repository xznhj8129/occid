...
OCCID is a domain-agnostic information model for C3ISR systems. It defines what can be known, said, commanded, and reported across entities, organizations, platforms, and networks.
...
OCCID does not replace these protocols. It provides the common information model that translations between them are written against.
