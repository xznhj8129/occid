...
export const OCCID_CONTRACT_GLOBAL_HASH = "bbbb1e2e414bbd4a997fda09119131bf362e7e5f10a5853f65ccf89091b4ffd3" as const;
...
export const ImageOrigin = Object.freeze({
  PHOTO: enumValue("ImageOrigin", "PHOTO", 0),
  VIDEO_CAPTURE: enumValue("ImageOrigin", "VIDEO_CAPTURE", 1),
  SCREEN_CAPTURE: enumValue("ImageOrigin", "SCREEN_CAPTURE", 2),
  GENERATED: enumValue("ImageOrigin", "GENERATED", 3),
  SCAN: enumValue("ImageOrigin", "SCAN", 4),
});
...
export const MediaDomain = Object.freeze({
  SPATIAL: enumValue("MediaDomain", "SPATIAL", 0),
  TEMPORAL: enumValue("MediaDomain", "TEMPORAL", 1),
  FREQUENCY: enumValue("MediaDomain", "FREQUENCY", 2),
  TIME_FREQUENCY: enumValue("MediaDomain", "TIME_FREQUENCY", 3),
});
export type MediaDomain = (typeof MediaDomain)[keyof typeof MediaDomain];

export const MediaLiveness = Object.freeze({
  FINISHED: enumValue("MediaLiveness", "FINISHED", 0),
  LIVE: enumValue("MediaLiveness", "LIVE", 1),
});
export type MediaLiveness = (typeof MediaLiveness)[keyof typeof MediaLiveness];

export const MediaSpectrum = Object.freeze({
  VISUAL: enumValue("MediaSpectrum", "VISUAL", 0),
  AUDIO: enumValue("MediaSpectrum", "AUDIO", 1),
  RADIO: enumValue("MediaSpectrum", "RADIO", 2),
  IR: enumValue("MediaSpectrum", "IR", 3),
  UV: enumValue("MediaSpectrum", "UV", 4),
  MOTION: enumValue("MediaSpectrum", "MOTION", 5),
  MATTER: enumValue("MediaSpectrum", "MATTER", 6),
});
export type MediaSpectrum = (typeof MediaSpectrum)[keyof typeof MediaSpectrum];

export const MediaTimeOrigin = Object.freeze({
  RECORDED: enumValue("MediaTimeOrigin", "RECORDED", 0),
  STREAMED: enumValue("MediaTimeOrigin", "STREAMED", 1),
});
export type MediaTimeOrigin = (typeof MediaTimeOrigin)[keyof typeof MediaTimeOrigin];
...
export const TelemetryType = Object.freeze({
  NONE: enumValue("TelemetryType", "NONE", 0),
  MSP: enumValue("TelemetryType", "MSP", 1),
  MAVLINK: enumValue("TelemetryType", "MAVLINK", 2),
...
export interface CaptureSize2D$Exact extends OCCIDModelValue<"CaptureSize2D"> {
  width: OCCIDInteger;
  height: OCCIDInteger;
}

export interface CaptureSize2D$Input {
  width: OCCIDInteger;
  height: OCCIDInteger;
}

export interface CaptureSize3D$Exact extends OCCIDModelValue<"CaptureSize3D"> {
  length: OCCIDInteger;
  width: OCCIDInteger;
  height: OCCIDInteger;
}

export interface CaptureSize3D$Input {
  length: OCCIDInteger;
  width: OCCIDInteger;
  height: OCCIDInteger;
}
...
export interface DurationalMedia$Exact extends OCCIDModelValue<"DurationalMedia"> {
  uid: UID;
  id: NamespacedIntID<"MediaItem">;
  content_type: MediaSpectrum;
  size: ByteCount | null;
...
export interface DurationalMedia$Input {
  uid: UID;
  id: NamespacedIntID<"MediaItem">;
  content_type: MediaSpectrum;
  size?: ByteCount | null;
...
export interface ImageSensor$Exact extends OCCIDModelValue<"ImageSensor"> {
  ...
  mount_attitude: EulerAngles | null;
}
...
export interface ImagingSensorState$Exact extends OCCIDModelValue<"ImagingSensorState"> {
  record: Record;
  subject_uid: UID;
  timestamp: Timestamp;
  run_state: SensorRunState;
  mode: SensorMode | null;
  gimbal_state: GimbalState | null;
  gimbal_attitude: EulerAngles | null;
  field_of_view: SensorFieldOfView | null;
}

export interface ImagingSensorState$Input {
  record: Record;
  subject_uid: UID;
  timestamp: Timestamp;
  run_state: SensorRunState;
...
export interface MediaProductionCapability$Exact extends OCCIDModelValue<"MediaProductionCapability"> {
...
export interface StillMedia$Exact extends OCCIDModelValue<"StillMedia"> {
  uid: UID;
  id: NamespacedIntID<"MediaItem">;
  content_type: MediaSpectrum;
  size: ByteCount | null;
...
export interface StillMedia$Input {
  uid: UID;
  id: NamespacedIntID<"MediaItem">;
  content_type: MediaSpectrum;
  size?: ByteCount | null;
...
export type AudioMedia = AudioMedia$Exact;
...
export type Capability = Capability$Exact | MediaProductionCapability$Exact;

export type CapabilityAdvert = CapabilityAdvert$Exact;

export type CaptureSize2D = CaptureSize2D$Exact;

export type CaptureSize3D = CaptureSize3D$Exact;
...
export type DurationalMedia = DurationalMedia$Exact | VideoMedia$Exact | LiveVideoStream$Exact | AudioMedia$Exact | SpectrumMedia$Exact | SpectrumRecording$Exact;
...
export type ImagingSensorState = ImagingSensorState$Exact;
...
export type Interface = Interface$Exact | RemoteControl$Exact;
...
export type Link = Link$Exact | Radio$Exact | FrequencyRange$Exact | ChannelSpec$Exact | RadioProfile$Exact;
...
export type Property = Property$Exact | CaptureSize2D$Exact | CaptureSize3D$Exact | Attribute$Exact | Symbology$Exact | CoTSymbology$Exact | MilitarySymbology$Exact | GroundNavigation$Exact | AirNavigation$Exact | MilitaryAirNavigation$Exact | SensorFieldOfView$Exact | Capability$Exact | MediaProductionCapability$Exact | Identity$Exact | StringName$Exact | IdentityBootstrap$Exact | Parameter$Exact | VideoConfig$Exact | ReceiverConfig$Exact | ChannelMapEntry$Exact | ModeRange$Exact | RobotController$Exact | Version$Exact | FirmwareInfo$Exact | MetadataValue$Exact | MeasurementQuality$Exact | Relationship$Exact | DirectedRelationship$Exact | EntityComponentRef$Exact | SpatialRelationship$Exact | MilitaryAffiliation$Exact;
...
export type Radio = Radio$Exact | FrequencyRange$Exact | ChannelSpec$Exact | RadioProfile$Exact;

export type RadioProfile = RadioProfile$Exact;
...
export type SensorState = SensorState$Exact | ImagingSensorState$Exact | TrackerState$Exact | FlightSensorConfiguration$Exact;
...
export type StillImage = StillImage$Exact | VideoFrame$Exact;

export type StillMedia = StillMedia$Exact | PointCloudMedia$Exact | StillImage$Exact | VideoFrame$Exact;
...
export type SubjectState = SubjectState$Exact | SensorState$Exact | ImagingSensorState$Exact | TrackerState$Exact | FlightSensorConfiguration$Exact | EntityState$Exact | OrganizationState$Exact | MilitaryOrganizationState$Exact;
...
export type VideoMedia = VideoMedia$Exact | LiveVideoStream$Exact;
...
export interface ExactModelMap {
  ...
  CaptureSize2D: CaptureSize2D$Exact;

  CaptureSize3D: CaptureSize3D$Exact;
  ...
  DurationalMedia: DurationalMedia$Exact;
  ...
  ImagingSensorState: ImagingSensorState$Exact;
...
export interface SemanticModelMap {
  ...
  CaptureSize2D: CaptureSize2D;

  CaptureSize3D: CaptureSize3D;
  ...
  DurationalMedia: DurationalMedia;
  ...
  ImagingSensorState: ImagingSensorState;
...
export interface ModelInputMap {
  ...
  CaptureSize2D: CaptureSize2D$Input;

  CaptureSize3D: CaptureSize3D$Input;
  ...
  DurationalMedia: DurationalMedia$Input;
  ...
  ImagingSensorState: ImagingSensorState$Input;
...
export const ENUM_REGISTRY: Readonly<StringMap<EnumSpec>> = Object.freeze({
  ...
  "MediaDomain": {package:"media",flags:false,members:{"SPATIAL":0,"TEMPORAL":1,"FREQUENCY":2,"TIME_FREQUENCY":3}},
  "MediaLiveness": {package:"media",flags:false,members:{"FINISHED":0,"LIVE":1}},
  "MediaSpectrum": {package:"media",flags:false,members:{"VISUAL":0,"AUDIO":1,"RADIO":2,"IR":3,"UV":4,"MOTION":5,"MATTER":6}},
  "MediaTimeOrigin": {package:"media",flags:false,members:{"RECORDED":0,"STREAMED":1}},
  ...
  "NATOSupplyClass": {package:"resource",flags:false,members:{"CLASS_I":0,"CLASS_II":1,"CLASS_III":2,"CLASS_IV":3,"CLASS_V":4,"CLASS_VI":5,"CLASS_VII":6,"CLASS_VIII":7,"CLASS_IX":8,"CLASS_X":9}},
...
export const MODEL_REGISTRY: Readonly<StringMap<ModelSpec>> = Object.freeze({
  ...
  "Data": {id:77,package:"data",semanticRole:"concept",parent:"Root",children:["Condition","Context","Event","Execution","SpatialMeasurement","Media","Observation","Property","Representation","State"],atomic:false,fields:{},fieldOrder:[]},
  ...
  "Definition": {id:80,package:"definition",semanticRole:"concept",parent:"Root",children:["ResourceTemplate","Frame","Coordinate","Geometry","DefinitionRelationship","SemanticType","OrgTemplate"],atomic:false,fields:{},fieldOrder:[]},
  ...
  "Interface": {id:172,package:"communication",semanticRole:"concept",parent:"Communication",children:["RemoteControl"],atomic:false,fields:{},fieldOrder:[]},
...
export const MODEL_NAME_BY_ID: Readonly<{ readonly [key: number]: ModelName }> = Object.freeze({
  ...
  199: "Location",
  200: "LocationState",
  201: "LocationUncertainty",
  202: "LoiterOrbit",
  203: "MGRSMapGrid",
  204: "Machine",
  205: "MaintenanceStatus",
  206: "MapGrid",
  207: "MapView",
  208: "Mark",
  209: "MarkdownText",
  210: "Measurement",
  211: "MeasurementGraphic",
  212: "MeasurementQuality",
  213: "Media",
  214: "MediaGraphic",
  215: "MediaItem",
  216: "MediaProductionCapability",
  ...
  235: "MilitaryPerson",
  236: "MilitaryStrength",
  237: "MilitarySupplyTemplate",
  238: "MilitarySymbolGraphic",
  239: "MilitarySymbology",
  240: "MilitaryUnitFlightPlan",
  241: "MissionEvent",
  242: "MissionRouteGeometry",
  243: "ModeRange",
  244: "MotionCommand",
  245: "MunitionAllocation",
  246: "NavReadinessState",
  247: "NavigationValidity",
  248: "Network",
  249: "NetworkAddress",
  250: "Node",
  251: "NodeHeartbeat",
  ...
  256: "Objective",
  257: "Observation",
  258: "ObservationMessage",
  259: "Opacity",
  260: "Operation",
  261: "OperationalContext",
  262: "OperationalPlan",
  263: "OrbatOrg",
  264: "Orbital",
  265: "OrgComposition",
  ...
  267: "OrgTemplate",
  268: "Organization",
  269: "OrganizationState",
  270: "OverlayLayer",
  271: "Parameter",
  272: "Path",
  273: "PathAnchor",
  274: "Payload",
  275: "PayloadAllocation",
  276: "PayloadMount",
  277: "PayloadPlan",
  278: "Person",
  279: "PersonnelTemplate",
  280: "PlainText",
  281: "Plan",
  282: "PlanContingency",
  283: "PlannedAirMission",
  284: "PlannedRoutePoints",
  285: "Platform",
  286: "PointCloudMedia",
  287: "Pose",
  288: "Position",
  ...
  291: "PowerState",
  292: "Predicate",
  293: "ProcessControlCommand",
  294: "Property",
  295: "Protocol",
  296: "ProtocolEventMessage",
  297: "ProtocolPayload",
  298: "Quantity",
  299: "RFSensor",
  300: "Radio",
  301: "RadioProfile",
  302: "RadiusMeasurement",
  303: "Range",
  304: "Ratio",
  305: "ReceiverConfig",
  306: "Record",
  ...
  310: "RemoteControl",
  311: "Representation",
  312: "RepresentationSource",
  313: "Resource",
  314: "ResourceCommand",
  315: "ResourceHolding",
  316: "ResourceRequirement",
  ...
  324: "Root",
  325: "Roster",
  326: "RouteMeasurement",
  327: "RoutePlan",
  328: "RuntimeLoadState",
  329: "RwsPose",
  330: "RwsState",
  331: "SIDC",
  332: "Scenario",
  333: "SemanticType",
  334: "SensorFieldOfView",
  335: "SensorPayload",
  336: "SensorState",
  337: "Set",
  338: "Shape",
  339: "Side",
  340: "SignalQuality",
  341: "SpatialMeasurement",
  342: "SpatialRelationship",
  343: "SpatialStruct",
  344: "SpectrumMedia",
  345: "SpectrumRecording",
  346: "SplashCorrection",
  347: "SpotterOrigin",
  348: "State",
  349: "StateChangeCommand",
  350: "StillImage",
  351: "StillMedia",
  352: "StringName",
  353: "StrokeStyle",
  ...
  390: "TrackerState",
  391: "Transform",
  392: "TransportCounters",
  393: "TransportError",
  394: "UAVTelemetryMessage",
  395: "UID",
  396: "UTMMapGrid",
  397: "UTMZone",
  398: "Uncertainty",
