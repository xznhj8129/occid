...
export const StandardIdentity = Object.freeze({
  OURS: enumValue("StandardIdentity", "OURS", 0),
  NEUTRAL: enumValue("StandardIdentity", "NEUTRAL", 1),
  UNKNOWN: enumValue("StandardIdentity", "UNKNOWN", 2),
  PENDING: enumValue("StandardIdentity", "PENDING", 3),
  FRIEND: enumValue("StandardIdentity", "FRIEND", 4),
  ASSUMED_FRIEND: enumValue("StandardIdentity", "ASSUMED_FRIEND", 5),
  SUSPECT: enumValue("StandardIdentity", "SUSPECT", 6),
  HOSTILE: enumValue("StandardIdentity", "HOSTILE", 7),
  JOKER: enumValue("StandardIdentity", "JOKER", 8),
  FAKER: enumValue("StandardIdentity", "FAKER", 9),
});
...
export type Property = Property$Exact | CaptureSize2D$Exact | CaptureSize3D$Exact | Attribute$Exact | Symbology$Exact | GroundNavigation$Exact | AirNavigation$Exact | MilitaryAirNavigation$Exact | SensorFieldOfView$Exact | Capability$Exact | MediaProductionCapability$Exact | Identity$Exact | StringName$Exact | IdentityBootstrap$Exact | Parameter$Exact | VideoConfig$Exact | ReceiverConfig$Exact | ChannelMapEntry$Exact | ModeRange$Exact | RobotController$Exact | Version$Exact | FirmwareInfo$Exact | MetadataValue$Exact | MeasurementQuality$Exact | Relationship$Exact | DirectedRelationship$Exact | EntityComponentRef$Exact | SpatialRelationship$Exact;
