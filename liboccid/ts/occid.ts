...
export const OCCID_CONTRACT_GLOBAL_HASH = "91a477af83027e8d9d4aefc8f6e779e80ba7fb4efe28d256202fba4611d3ab9b" as const;
...
export interface ExecutionStatus$Exact extends OCCIDModelValue<"ExecutionStatus"> {
  record: Record;
  subject_uid: UID;
  timestamp: Timestamp;
  phase: ExecutionPhase;
...
export interface ExecutionStatus$Input {
  record: Record;
  subject_uid: UID;
  timestamp: Timestamp;
  phase: ExecutionPhase;
...
export type SubjectState = SubjectState$Exact | ExecutionStatus$Exact | SensorState$Exact | ImagingSensorState$Exact | TrackerState$Exact | FlightSensorConfiguration$Exact | EntityState$Exact | OrganizationState$Exact | MilitaryOrganizationState$Exact;
...
export const MODEL_REGISTRY: Readonly<StringMap<ModelSpec>> = Object.freeze({
  ...
  "Media": {id:214,package:"media",semanticRole:"concept",parent:"Data",children:["MediaItem"],atomic:false,fields:{},fieldOrder:[]},
  ...
  "MediaProductionCapability": {id:217,package:"capability",semanticRole:"representation",parent:"Capability",children:[],atomic:false,fields:{"content_types":{type:{kind:"list",item:{kind:"enum",name:"MediaSpectrum"}},optional:false,const:false,default:null}},fieldOrder:["content_types"]},
  "MediaRepresentationSource": {id:218,package:"representation",semanticRole:"representation",parent:"RepresentationSource",children:[],atomic:false,fields:{"media_uid":{type:{kind:"model",name:"UID"},optional:false,const:false,default:null},"registration":{type:{kind:"model",name:"GeoRegistration"},optional:true,const:false,default:{kind:"literal",value:null}}},fieldOrder:["media_uid","registration"]},
...
export const MODEL_NAME_BY_ID: Readonly<{ readonly [key: number]: ModelName }> = Object.freeze({
  ...
  116: "ExecutionStatus",
  117: "ExternalRepresentationSource",
  118: "FillStyle",
  119: "Fires",
  120: "FirmwareInfo",
  121: "FlightAssignment",
  122: "FlightControlState",
  123: "FlightEvent",
  124: "FlightLevelBand",
  125: "FlightMissionPoint",
  126: "FlightSensorConfiguration",
  127: "FlyingOrg",
  128: "FpvProfile",
  129: "Frame",
  130: "Frequency",
  ...
  161: "HealthSnapshot",
  162: "Hertz",
  163: "HumanTextMessage",
  164: "ID",
  165: "IdentifiedRepresentation",
  166: "Identity",
  167: "IdentityBootstrap",
  168: "ImageSensor",
  169: "ImagingSensorState",
  170: "ImuSample",
  171: "Input",
  172: "IntID",
  173: "Interface",
  ...
  215: "MediaGraphic",
  216: "MediaItem",
  217: "MediaProductionCapability",
  218: "MediaRepresentationSource",
  219: "MeshLink",
  220: "MeshNode",
  221: "MeshPositionSample",
  222: "MeshReceiveMetrics",
  223: "MeshView",
  224: "MeshtasticMessage",
  225: "Message",
  226: "MessageTransferResult",
  227: "MetadataValue",
  228: "MilitaryAffiliation",
  229: "MilitaryAirMachine",
  230: "MilitaryAirNavigation",
  231: "MilitaryGroundMachine",
  232: "MilitaryMachine",
  233: "MilitaryOrg",
  234: "MilitaryOrgTemplate",
  235: "MilitaryOrganizationState",
  236: "MilitaryPerson",
  ...
  268: "OrgTemplate",
  269: "Organization",
  270: "OrganizationState",
  271: "OverlayLayer",
  272: "Parameter",
  273: "Path",
  274: "PathAnchor",
  275: "Payload",
  276: "PayloadAllocation",
  277: "PayloadMount",
  278: "PayloadPlan",
  279: "Person",
  280: "PersonnelTemplate",
  281: "PlainText",
  282: "Plan",
  283: "PlanContingency",
  284: "PlannedAirMission",
  285: "PlannedRoutePoints",
  286: "Platform",
  287: "PointCloudMedia",
  288: "Pose",
  289: "Position",
  ...
  292: "PowerState",
  293: "Predicate",
  294: "ProcessControlCommand",
  295: "Property",
  296: "Protocol",
  297: "ProtocolEventMessage",
  298: "ProtocolPayload",
  299: "Quantity",
  300: "RFSensor",
  301: "Radio",
  302: "RadioProfile",
  303: "RadiusMeasurement",
  304: "Range",
  305: "Ratio",
  306: "ReceiverConfig",
  307: "Record",
  ...
  311: "RemoteControl",
  312: "Representation",
  313: "RepresentationSource",
  314: "Resource",
  315: "ResourceCommand",
  316: "ResourceHolding",
  317: "ResourceRequirement",
  ...
  325: "Root",
  326: "Roster",
  327: "RouteMeasurement",
  328: "RoutePlan",
  329: "RuntimeLoadState",
  330: "RwsPose",
  331: "RwsState",
  332: "SIDC",
  333: "Scenario",
  334: "SemanticType",
  335: "SensorFieldOfView",
  336: "SensorPayload",
  337: "SensorState",
  338: "Set",
  339: "Shape",
  340: "Side",
  341: "SignalQuality",
  342: "SpatialMeasurement",
  343: "SpatialRelationship",
  344: "SpatialStruct",
  345: "SpectrumMedia",
  346: "SpectrumRecording",
  347: "SplashCorrection",
  348: "SpotterOrigin",
  349: "State",
  350: "StateChangeCommand",
  351: "StillImage",
  352: "StillMedia",
  353: "StringName",
  354: "StrokeStyle",
  ...
  391: "TrackerState",
  392: "Transform",
  393: "TransportCounters",
  394: "TransportError",
  395: "UAVTelemetryMessage",
  396: "UID",
  397: "UTMMapGrid",
  398: "UTMZone",
  399: "Uncertainty",
