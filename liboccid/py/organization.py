...
class Side(OCCIDModel):
    'Named operational side or alignment grouping; membership is declared by the member through its side reference, and relative friendly/hostile identity is modeled separately'
